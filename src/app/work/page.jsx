...
const projects = [
  ...
  },
  {
    ...
    title: "DrugEye",
    description:
      "A smart medicine reference and lookup app featuring full-text search with Soundex support, live autocomplete with keyboard navigation, bidirectional drug alternatives, and dark mode.",
    stack: [
      { name: "React" },
      { name: "TypeScript" },
      { name: "Laravel" },
    ...
    image: "/assets/work/drugeye.png",
    live: "https://drugs.higamaplatform.com/",
    github: "https://github.com/mo7amedAlaa/Drugs_Finder",
  },
  {
    num: "09",
    category: "FullStack",
    title: "CORE S+",
    description:
      "A digital management platform for cupping therapy, massage, and sports rehabilitation centers — featuring multi-step booking, admin dashboard, context-aware medical forms, and race-condition-safe scheduling.",
    stack: [
      { name: "React" },
      { name: "TypeScript" },
      { name: "Laravel" },
    ...
    image: "/assets/work/cores.png",
    live: "https://higamaplatform.com",
    github: "https://github.com/mo7amedAlaa/hijama-platform",
  },
];
